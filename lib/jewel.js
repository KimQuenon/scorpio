...
// Function to map the raw data to a jewel object
...
// Function to fetch multiple jewels with specified fields
export async function getJewels(pageSize, limit) {
  try {
...
// Function to fetch a single jewel with specified fields
